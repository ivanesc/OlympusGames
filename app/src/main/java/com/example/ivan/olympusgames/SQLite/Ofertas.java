...
public class Ofertas {
    ...
    public Ofertas(int Id_Juego, Context contexto) {
    ...
    private void add(Context contexto) {
        ...
        values.put(SQLite_DB.Tabla_Ofertas.Id_Juego, this.Id_Juego);

        db.insert(SQLite_DB.Tabla_Ofertas.Nombre_Tabla, null, values);
        db.close();
    }
    ...
    public static void delete(Context contexto, int id) {
        ...
        db.delete(SQLite_DB.Tabla_Ofertas.Nombre_Tabla, SQLite_DB.Tabla_Ofertas.Id+"=?", new String[]{"" + id});
        db.close();
    }
    ...
    public static int getAll(Context contexto) {
        ...
        Cursor cursor = db.query(
                false // Distinct
                , SQLite_DB.Tabla_Ofertas.Nombre_Tabla // Tabla
                , new String[]{SQLite_DB.Tabla_Ofertas.Id, SQLite_DB.Tabla_Ofertas.Id_Juego} // Columnas
                , null // Cláusula where
    ...
    public static int getFirst(Context contexto) {
        ...
        Cursor cursor = db.query(
                false // Distinct
                , SQLite_DB.Tabla_Ofertas.Nombre_Tabla // Tabla
                , new String[]{SQLite_DB.Tabla_Ofertas.Id} // Columnas
                , null // Cláusula where
                , null // Vector de argumentos
                , null // Cláusula group by.
                , null // Cláusula having
                , SQLite_DB.Tabla_Ofertas.Id // Cláusula order by.
                , "1" // Cláusula limit
        );
    ...
    public static boolean exist(Context contexto, int id_juego) {
        ...
        Cursor cursor = db.query(
                ...
                , SQLite_DB.Tabla_Ofertas.Nombre_Tabla // Tabla
                , new String[]{SQLite_DB.Tabla_Ofertas.Id} // Columnas
                , SQLite_DB.Tabla_Ofertas.Id_Juego+"=?" // Cláusula where
